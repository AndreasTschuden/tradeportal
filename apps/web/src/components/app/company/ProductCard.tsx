...
const ProductCard = ({ product }: { product: productWithStatsType }) => {
	...
	return (
		<div className="flex flex-col items-start justify-between gap-4 rounded-2xl border border-gray-400 p-3 px-4 md:flex-row md:items-center md:px-5">
			<div className="relative aspect-square h-20">
				<Image
					src={`${process.env.NEXT_PUBLIC_MINIO_PICTURE_BASE_URL}/images/products/${Object.values(product.specifications.attributes[0].images)[0]}`}
					alt={product.name}
					fill
