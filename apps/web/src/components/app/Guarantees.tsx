...
const Guarantees = () => {
  return (
    <div className="border-t border-b min-h-[15vh] flex items-center justify-between lg:flex-row lg:py-0 py-10 flex-col gap-10 w-full md:px-30 px-5" id="gurantees-section">
